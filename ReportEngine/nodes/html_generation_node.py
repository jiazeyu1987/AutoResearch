...
<body>
    <div class="container">
        ...
        <div class="meta">
            ...
            <strong>报告类型:</strong> 综合科研分析报告
        </div>
        
        <h2>研究摘要</h2>
        <div class="section">
            本报告整合了多个智能体的研究结果，为您提供全面的科研分析洞察。
            通过对查询主题"{query}"的深度分析，我们从多个维度展现了当前的研究态势和发现。
        </div>
        
        {f'<h2>QueryEngine研究结果</h2><div class="section"><pre>{query_report}</pre></div>' if query_report else ''}
        
        {f'<h2>MediaEngine研究结果</h2><div class="section"><pre>{media_report}</pre></div>' if media_report else ''}
        
        {f'<h2>InsightEngine研究结果</h2><div class="section"><pre>{insight_report}</pre></div>' if insight_report else ''}
        
        {f'<h2>智能体讨论数据</h2><div class="section"><pre>{forum_logs}</pre></div>' if forum_logs else ''}
        
        <h2>综合结论</h2>
        <div class="section">
            基于多个智能体的综合研究，我们对"{query}"主题进行了全面分析。
            各智能体从不同角度提供了深入洞察，为科研决策提供了重要参考。
        </div>
        
        <div class="footer">
            <p>本报告由科研智能分析平台自动生成</p>
